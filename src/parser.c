...
int is_redirection(struct argv_t *arg)
{
    if (arg->len >= 3)
    {
        ...
        {
            if (strcmp(arg->data[i], "<") == 0 || strcmp(arg->data[i], ">") == 0 || strcmp(arg->data[i], ">|") == 0 || strcmp(arg->data[i], ">>") == 0 || strcmp(arg->data[i], "2>") == 0 || strcmp(arg->data[i], "2>|") == 0 || strcmp(arg->data[i], "2>>") == 0 || strcmp(arg->data[i], "|") == 0 || strcmp(arg->data[i], "<(") == 0)
            {
                return i;
            }
        }
